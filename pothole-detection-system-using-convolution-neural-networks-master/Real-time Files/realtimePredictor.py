...
if __name__ == '__main__':
    ...
    loadedModel = load_model('F:\pothole-detection-system-using-convolution-neural-networks-master\pothole-detection-system-using-convolution-neural-networks-master\Real-time Files/full_model.h5')
